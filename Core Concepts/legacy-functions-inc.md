---
title: Legacy functions.inc.php Coexistence with BMO
...
Before BMO (FreePBX 12+), modules exposed procedural APIs through `functions.inc.php`. That layer still loads on every full bootstrap for active modules, sitting alongside your BMO class. You'll see both patterns in the wild — understanding when each loads and how they interact saves a lot of "function not found" debugging.
...
This global controls whether legacy procedural code loads at all — critical for AJAX and handler requests.
